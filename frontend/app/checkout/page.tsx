...
export default function CheckoutPage() {
  ...
  // ⭐ Check authentication on mount - Block both unauthenticated AND guest users
  useEffect(() => {
    setIsLoading(true);
    ...
    if (!isAuthenticated || isGuestUser) {
      ...
      const message = isGuestUser 
        ? '🔗 Please create an account to complete checkout'
    ...
    setIsLoading(false);
  }, [isAuthenticated, user, cart.length, router]);
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#0f1419] to-[#1a2332] py-8 sm:py-10 lg:py-12 xl:py-16 2xl:py-20">
      <div className="max-w-6xl xl:max-w-7xl 2xl:max-w-full mx-auto px-4 sm:px-6 lg:px-8 xl:px-12 2xl:px-16">
        {/* Error Alert */}
        {error && (
        ...
        <div className="grid lg:grid-cols-3 gap-8 xl:gap-12 2xl:gap-16">
          {/* Checkout Form */}
          <div className="lg:col-span-2">
            <div className="bg-[#1a2332] rounded-lg p-6 sm:p-8 lg:p-10 xl:p-12 border border-[#232a3a]">
              <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-8 xl:mb-12">Checkout</h1>

              {/* Step Indicator */}
              <div className="flex gap-4 sm:gap-6 lg:gap-8 mb-8 xl:mb-12">
              ...
              {step === 'address' && (
                <>
                  <div className="mb-8 xl:mb-12">
                    <h2 className="text-xl sm:text-2xl font-semibold text-white mb-6 xl:mb-8">Shipping Address</h2>
                  ...
                  {/* Shipping Method */}
                  <div className="mb-8 xl:mb-12">
                    <h2 className="text-xl sm:text-2xl font-semibold text-white mb-4 xl:mb-6">Shipping Method</h2>
                  ...
                  <button
                    ...
                    disabled={loading}
                    className="w-full bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 disabled:from-purple-600/50 disabled:to-pink-600/50 text-white font-bold py-4 sm:py-5 lg:py-6 rounded-lg transition-all text-lg xl:text-xl"
                  >
                    Review Order →
                  </button>
                </>
              ...
              {step === 'review' && (
                <>
                  <div className="space-y-6 xl:space-y-8">
                    <div>
                      <h3 className="text-lg sm:text-xl font-bold text-white mb-3 xl:mb-5">Items</h3>
                      {cart.map((item) => (
                    ...
                    <div className="bg-gradient-to-r from-purple-600/20 to-pink-600/20 border border-purple-500/30 rounded-lg p-4 sm:p-6 lg:p-8">
                      <div className="flex justify-between text-[#bfc8e6] mb-3 text-sm xl:text-base">
                        <span>Subtotal:</span>
                      ...
                      <div className="flex justify-between text-[#bfc8e6] py-3 border-t border-purple-500/30 text-sm xl:text-base">
                        <span>Tax:</span>
                        <span>₹{tax}</span>
                      </div>
                      <div className="flex justify-between items-baseline pt-3 border-t border-purple-500/30">
                        <span className="text-white font-bold text-lg xl:text-xl">Total:</span>
                    ...
                    <div className="bg-[#1a2535] border border-[#3d4f62] rounded-lg p-6 sm:p-8 lg:p-10">
                      <div className="flex items-center gap-4 sm:gap-6 mb-6 xl:mb-8">
                      ...
                      <button
                        ...
                        className="w-full bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 disabled:from-blue-600/50 disabled:to-purple-600/50 text-white font-bold py-3 sm:py-4 lg:py-5 rounded-lg transition-all flex items-center justify-center gap-2 text-base xl:text-lg"
                      >
                        {loading ? (
                          <>
                    ...
                    <button
                      ...
                      disabled={loading}
                      className="w-full bg-[#2d3f52] hover:bg-[#3d4f62] text-white font-bold py-3 sm:py-4 lg:py-5 rounded-lg transition disabled:opacity-50 disabled:cursor-not-allowed text-base xl:text-lg"
                    >
                      ← Back
                    </button>
                  </div>
          ...
          <div className="lg:col-span-1">
            <div className="bg-gradient-to-br from-[#181e2a] to-[#1a2332] rounded-lg p-6 sm:p-8 lg:p-10 border border-[#232a3a] sticky top-8 xl:top-12">
              <h2 className="text-xl sm:text-2xl font-bold text-white mb-6 xl:mb-8">Order Summary</h2>

              <div className="space-y-3 sm:space-y-4 mb-6 xl:mb-8 max-h-96 overflow-y-auto">
                {cart.map((item) => (
                  <div
                    key={`${item.id}-${item.size}-${item.color}`}
                    className="flex justify-between items-start text-sm xl:text-base"
                  >
              ...
              <div className="border-t border-[#3d4f62] pt-4 sm:pt-6 space-y-3 sm:space-y-4">
                <div className="flex justify-between text-[#bfc8e6] text-sm xl:text-base">
                  <span>Subtotal</span>
                  <span>₹{subtotal.toLocaleString()}</span>
                </div>
                <div className="flex justify-between text-[#bfc8e6] text-sm xl:text-base">
                ...
                <div className="flex justify-between text-lg sm:text-xl lg:text-2xl font-bold text-white mt-4 sm:mt-6 pt-4 sm:pt-6 border-t border-[#3d4f62]">
                  <span>Total</span>
